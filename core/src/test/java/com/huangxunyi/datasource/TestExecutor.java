...
public class TestExecutor {
    ...
    public void dataSource() {
        ds = new SimpleDataSource("com.mysql.cj.jdbc.Driver", "jdbc:mysql://localhost:33060/test?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT", "root", "root");
    ...
    public void testSimpleExecutor() throws SQLException {
        ...
        int insert = e.update(new MappedStatement("1", "2", "config.Log", "insert into sys_log_login values ('402880e4646e54dc01646e555e950001','2018-07-06 14:44:06','192.168.0.100','权限认证成功','成功','1','402880e4641c692001641c6be3910002')", SqlType.INSERT), null);

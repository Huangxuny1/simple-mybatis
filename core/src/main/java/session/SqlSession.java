...
public interface SqlSession extends Closeable {
  ...
  /**
   * Retrieve a single row mapped from the executor.statement key
...
//   * @param executor.statement Unique identifier matching the executor.statement to use.
//   * @param rowBounds RowBound instance to limit the query results
//   * @param handler ResultHandler that will handle each retrieved row
//   * @return Mapped object
//   */
//  void select(String executor.statement, Object parameter, RowBounds rowBounds, ResultHandler handler);

  /**
   * Execute an insert executor.statement.
